...
/*===========================*/
/* 3. PROGRAM FOR MIV BOUNDS */
/*===========================*/
capture program drop miv_bounds
program miv_bounds, rclass
...
* this part is not fully automated
	forvalues i = 1 / `max_d' {
		...
		di "MIV Y`i' = (`return(lb_Y`i')' , `return(ub_Y`i')')"
	}
	...
	forvalues j = 1 / `max_d_1' {	
		...
		di " "
		di "Average Treatment Effects:"	
		di "MIV ATE 5-4 = (`return(lb_ATE_54)' , `return(ub_ATE_54)')"	
		di "MIV ATE 5-3 = (`return(lb_ATE_53)' , `return(ub_ATE_53)')"
		di "MIV ATE 5-2 = (`return(lb_ATE_52)' , `return(ub_ATE_52)')"
		di "MIV ATE 5-1 = (`return(lb_ATE_51)' , `return(ub_ATE_51)')"
		di "------------"
		di "MIV ATE 4-3 = (`return(lb_ATE_43)' , `return(ub_ATE_43)')"
		di "MIV ATE 4-2 = (`return(lb_ATE_42)' , `return(ub_ATE_42)')"
		di "MIV ATE 4-1 = (`return(lb_ATE_41)' , `return(ub_ATE_41)')"
		di "------------"
		di "MIV ATE 3-2 = (`return(lb_ATE_32)' , `return(ub_ATE_32)')"
		di "MIV ATE 3-1 = (`return(lb_ATE_31)' , `return(ub_ATE_21)')"
		di "------------"
		di "MIV ATE 2-1 = (`return(lb_ATE_21)' , `return(ub_ATE_21)')"
	...
	* now convert to beta's
	...
	forvalues j = 1/5 {  // this is to get the multiplicaiton factors to convert to beta
		...
		di " "
		di "Betas:"
		di "MIV Beta 5-4 = (" round(factor_d54 * `return(lb_ATE_54)', .001) "," round(factor_d54 * `return(ub_ATE_54)', .001) ")"	
		di "MIV Beta 5-3 = (" round(factor_d53 * `return(lb_ATE_53)', .001) "," round(factor_d53 * `return(ub_ATE_53)', .001) ")"
		di "MIV Beta 5-2 = (" round(factor_d52 * `return(lb_ATE_52)', .001) "," round(factor_d52 * `return(ub_ATE_52)', .001) ")"
		di "MIV Beta 5-1 = (" round(factor_d51 * `return(lb_ATE_51)', .001) "," round(factor_d51 * `return(ub_ATE_51)', .001) ")"
		di "------------"
		di "MIV Beta 4-3 = (" round(factor_d43 * `return(lb_ATE_43)', .001) "," round(factor_d43 * `return(ub_ATE_43)', .001) ")"
		di "MIV Beta 4-2 = (" round(factor_d42 * `return(lb_ATE_42)', .001) "," round(factor_d42 * `return(ub_ATE_42)', .001) ")"
		di "MIV Beta 4-1 = (" round(factor_d41 * `return(lb_ATE_41)', .001) "," round(factor_d41 * `return(ub_ATE_41)', .001) ")"
		di "------------"
		di "MIV Beta 3-2 = (" round(factor_d32 * `return(lb_ATE_32)', .001) "," round(factor_d32 * `return(ub_ATE_32)', .001) ")"
		di "MIV Beta 3-1 = (" round(factor_d31 * `return(lb_ATE_31)', .001) "," round(factor_d31 * `return(ub_ATE_21)', .001) ")"
		di "------------"
		di "MIV Beta 2-1 = (" round(factor_d21 * `return(lb_ATE_21)', .001) "," round(factor_d21 * `return(ub_ATE_21)', .001) ")"
...
/*===========================*/
/* 4. PROGRAM FOR MTA BOUNDS */
/*===========================*/
capture program drop mta_bounds
program mta_bounds, rclass 
	...
	forvalues i = 1 / `max_d' {		
		...
		if `sign' == 2 {   // MTA+
			return scalar lb_Y`i' = round(`mean' * `probgeq' + `ymin' * (1 - `probgeq'), 0.001)
			return scalar ub_Y`i' = round(`mean' * `probleq' + `ymax' * (1 - `probleq'), 0.001)
		}
		
		else if `sign' == 1 {   // MTA-
			return scalar lb_Y`i' = round(`mean' * `probleq' + `ymin' * (1 - `probleq'), 0.001)
			return scalar ub_Y`i' = round(`mean' * `probgeq' + `ymax' * (1 - `probgeq'), 0.001)
		}
	...
	*	di "MTA Y`i' = (`return(lb_Y`i')' , `return(ub_Y`i')')"
	}
	...
	*	di " "
	*	di "Average Treatment Effects:"
	*	di "MTA ATE 5-4 = (`return(lb_ATE_54)' , `return(ub_ATE_54)')"	
	*	di "MTA ATE 5-3 = (`return(lb_ATE_53)' , `return(ub_ATE_53)')"
	*	di "MTA ATE 5-2 = (`return(lb_ATE_52)' , `return(ub_ATE_52)')"
	*	di "MTA ATE 5-1 = (`return(lb_ATE_51)' , `return(ub_ATE_51)')"
	*	di "------------"
	*	di "MTA ATE 4-3 = (`return(lb_ATE_43)' , `return(ub_ATE_43)')"
	*	di "MTA ATE 4-2 = (`return(lb_ATE_42)' , `return(ub_ATE_42)')"
	*	di "MTA ATE 4-1 = (`return(lb_ATE_41)' , `return(ub_ATE_41)')"
	*	di "------------"
	*	di "MTA ATE 3-2 = (`return(lb_ATE_32)' , `return(ub_ATE_32)')"
	*	di "MTA ATE 3-1 = (`return(lb_ATE_31)' , `return(ub_ATE_21)')"
	*	di "------------"
	*	di "MTA ATE 2-1 = (`return(lb_ATE_21)' , `return(ub_ATE_21)')"
	...
	* now convert to beta's
	...
	forvalues j = 1/5 {  // this is to get the multiplicaiton factors to convert to beta
		...
		di " "
		di "Betas:"
		di "MTA Beta 5-4 = (" round(factor_d54 * `return(lb_ATE_54)', .001) "," round(factor_d54 * `return(ub_ATE_54)', .001) ")"	
		di "MTA Beta 5-3 = (" round(factor_d53 * `return(lb_ATE_53)', .001) "," round(factor_d53 * `return(ub_ATE_53)', .001) ")"
		di "MTA Beta 5-2 = (" round(factor_d52 * `return(lb_ATE_52)', .001) "," round(factor_d52 * `return(ub_ATE_52)', .001) ")"
		di "MTA Beta 5-1 = (" round(factor_d51 * `return(lb_ATE_51)', .001) "," round(factor_d51 * `return(ub_ATE_51)', .001) ")"
		di "MTA Average Beta = (" `return(ave_beta_lb)' " , " `return(ave_beta_ub)' ")"
		di "------------"
		di "MTA Beta 4-3 = (" round(factor_d43 * `return(lb_ATE_43)', .001) "," round(factor_d43 * `return(ub_ATE_43)', .001) ")"
		di "MTA Beta 4-2 = (" round(factor_d42 * `return(lb_ATE_42)', .001) "," round(factor_d42 * `return(ub_ATE_42)', .001) ")"
		di "MTA Beta 4-1 = (" round(factor_d41 * `return(lb_ATE_41)', .001) "," round(factor_d41 * `return(ub_ATE_41)', .001) ")"
		di "------------"
		di "MTA Beta 3-2 = (" round(factor_d32 * `return(lb_ATE_32)', .001) "," round(factor_d32 * `return(ub_ATE_32)', .001) ")"
		di "MTA Beta 3-1 = (" round(factor_d31 * `return(lb_ATE_31)', .001) "," round(factor_d31 * `return(ub_ATE_21)', .001) ")"
		di "------------"
		di "MTA Beta 2-1 = (" round(factor_d21 * `return(lb_ATE_21)', .001) "," round(factor_d21 * `return(ub_ATE_21)', .001) ")"
